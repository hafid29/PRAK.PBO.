...
public class frmpeminjaman extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1941723009Hafid> list = new Peminjaman1941723009Hafid().getAll();
        Object rowData[] = new Object[5];
        
        tblPeminjaman.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getmIdpeminjaman();
            rowData[1] = list.get(i).getAnggota().getmNama();
            rowData[2] = list.get(i).getBuku().getmJudul();
            rowData[3] = list.get(i).getmTanggalpinjam();
            rowData[4] = list.get(i).getmTanggalkembali();
    ...
    public void cariAnggota(String keyword){
        Anggota1941723009Hafid anggota = new Anggota1941723009Hafid().getById(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getmNama());
    }
    
    public void cariBuku(String keyword){
        Buku1941723009Hafid buku = new Buku1941723009Hafid().getById(Integer.parseInt(keyword));
        jLabel7.setText("Judul Buku : "+buku.getmJudul());
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1941723009Hafid pmj = new Peminjaman1941723009Hafid();
        pmj.setmIdpeminjaman(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1941723009Hafid anggota = new Anggota1941723009Hafid().getById(Integer.parseInt(txtIdAnggota.getText()));
        Buku1941723009Hafid buku = new Buku1941723009Hafid().getById(Integer.parseInt(txtIdBuku.getText()));
        
        pmj.setAnggota(anggota);
        pmj.setBuku(buku);
        pmj.setmTanggalpinjam(txtTanggalPinjam.getText());
        pmj.setmTanggalkembali(txtTanggalKembali.getText());
        pmj.save();
        txtIdPeminjaman.setText(Integer.toString(pmj.getmIdpeminjaman()));
        tampilkanData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1941723009Hafid pmj = new Peminjaman1941723009Hafid().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.delete();
        kosongkanForm();
        tampilkanData();
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        txtIdPeminjaman.setText(String.valueOf(pmj.getmIdpeminjaman()));
        txtIdAnggota.setText(String.valueOf(pmj.getAnggota().getmIdAnggota()));
        jLabel6.setText("Nama Anggota : "+pmj.getAnggota().getmNama());
        
        txtIdBuku.setText(String.valueOf(pmj.getBuku().getmIdbuku()));
        jLabel7.setText("Judul Buku : "+pmj.getBuku().getmJudul());
        
        txtTanggalPinjam.setText(pmj.getmTanggalpinjam());
        txtTanggalKembali.setText(pmj.getmTanggalkembali());
