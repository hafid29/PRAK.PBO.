...
public class frmbuku extends javax.swing.JFrame {
    ...
    public void tampilkanData() {
        ...
        ArrayList<Buku1941723009Hafid> list = new Buku1941723009Hafid().getAll();
        Object rowData[] = new Object[5];
        
        tblBuku.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getmIdbuku();
            rowData[1] = list.get(i).getKategori().getmNama();
            rowData[2] = list.get(i).getmJudul();
            rowData[3] = list.get(i).getmPenulis();
            rowData[4] = list.get(i).getmPenerbit();
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Kategori", "Judul", "Penulis", "Penerbit"};
        ArrayList<Buku1941723009Hafid> list = new Buku1941723009Hafid().search(keyword);
        Object rowData[] = new Object[5];
        
        tblBuku.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Buku1941723009Hafid buku : list) {
            rowData[0] = buku.getmIdbuku();
            rowData[1] = buku.getKategori().getmNama();
            rowData[2] = buku.getmJudul();
            rowData[3] = buku.getmPenulis();
            rowData[4] = buku.getmPenerbit();
    ...
    public void tampilkanCmbKategori () {
        cmbKategori.setModel(new DefaultComboBoxModel(new Kategori1941723009Hafid().getAll().toArray()));
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        // TODO add your handling code here:
        Buku1941723009Hafid buku = new Buku1941723009Hafid();
        buku.setmIdbuku(Integer.parseInt(txtIdBuku.getText()));
        buku.setKategori((Kategori1941723009Hafid)cmbKategori.getSelectedItem());
        buku.setmJudul(txtJudul.getText());
        buku.setmPenulis(txtPenulis.getText());
        buku.setmPenerbit(txtPenerbit.getText()); 
        buku.save();
        txtIdBuku.setText(Integer.toString(buku.getmIdbuku()));
        tampilkanData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1941723009Hafid buku = new Buku1941723009Hafid().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.delete();
        kosongkanForm();
        tampilkanData();
